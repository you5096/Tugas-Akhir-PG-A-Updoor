...
void Menu::InitButton() {
	string buttons[NUM_BUTTON] = { "start-menu.png", "music-menu.png", "quit-menu.png" };
	string hover_buttons[NUM_BUTTON] = { "start-hover.png", "music-hover.png", "quit-hover.png" };
...
void Menu::RenderButton() {
	...
	for (int i = 0; i < NUM_BUTTON; i++) {
		...
		mat4 model;
		model = translate(model, vec3((sw - button_width[i]) / 2, (i + 1) * 100, 0.0f));
